...
namespace AP.IO
{
    public class Directory : FileSystemEntry
    {
        ...
        {
            FileSystem.Context.ClearDirectory(this, permanent);
        }
        ...
        /// <returns></returns>
        public IEnumerable<FileSystemEntry> Open(DirectorySearchFilter filter = DirectorySearchFilter.FilesAndDirectories, string searchPattern = "*")
        {
            return FileSystem.Context.OpenDirectory(this, filter, searchPattern);
        }
        ...
        public virtual new DirectoryAttributes Attributes
        {
            get
            {
                return (DirectoryAttributes)System.IO.File.GetAttributes(this.FullName);
            }
            set
            {
        ...
        public override DateTimeOffset DateAccessed
        {
            get
            {
                return System.IO.Directory.GetLastAccessTimeUtc(this.FullName);
            }
            set
            {
                System.IO.Directory.SetLastAccessTimeUtc(this.FullName, value.UtcDateTime);
            }
        }
        ...
        public override DateTimeOffset DateCreated
        {
            get
            {
                return System.IO.Directory.GetCreationTimeUtc(this.FullName);
            }
            set
            {
                System.IO.Directory.SetCreationTimeUtc(this.FullName, value.UtcDateTime);
            }
        }
        ...
        public override DateTimeOffset DateModified
        {
            get
            {
                return System.IO.Directory.GetLastWriteTimeUtc(this.FullName);
            }
            set
            {
                System.IO.Directory.SetLastWriteTimeUtc(this.FullName, value.UtcDateTime);
            }
        }
