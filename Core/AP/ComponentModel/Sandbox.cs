...
namespace AP.ComponentModel
{
    ...
    public class Sandbox : DisposableObject
    {
        ...
        private void Notify(object sender, Exception exception)
        {            
            this.OnErrorOccured(this.CreateErrorLoggerEventArgs(this.CreateExceptionInfo(sender, exception)));
        }
        ...
        /// <returns></returns>
        protected virtual ErrorLoggerEventArgs CreateErrorLoggerEventArgs(ExceptionInfo errorInfo)
        {
            return new ErrorLoggerEventArgs(errorInfo);
        }
        ...
        /// <param name="exception"></param>
        /// <returns></returns>
        protected virtual ExceptionInfo CreateExceptionInfo(object sender, Exception exception)
        {
            return new ExceptionInfo(sender, exception);
        }
