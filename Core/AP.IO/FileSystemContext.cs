...
public class FileSystemContext
{
    ...
    /// The FilesHelper.
    /// </summary>
    public FilesHelper Files => _files;

    /// <summary>
    /// The DirectoriesHelper.
    /// </summary>
    public DirectoriesHelper Directories => _directories;
    ...
    protected internal virtual string GetExtension(File file) => System.IO.Path.GetExtension(file.FullName);
    ...
    protected internal virtual string GetName(FileSystemEntry target) => System.IO.Path.GetFileName(target.FullName);
