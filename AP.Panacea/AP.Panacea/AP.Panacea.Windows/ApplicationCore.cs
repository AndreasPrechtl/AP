...
namespace AP.Panacea.Windows
{
    public class ApplicationCore : AP.Panacea.ApplicationCore<Request, Response>
    {
        ...
        {
            return new Response(ResponseType.Authorized, result, uri, request, null, null);
        }

        protected override Response HandleRouteBlocked(Request request, IUri uri)
        {
            return new Response(ResponseType.RouteBlocked, null, uri, request, null, null);
        }

        protected override Response HandleRouteNotFound(Request request)
        {
            return new Response(ResponseType.RouteNotFound, null, null, request, null, null);
        }

        protected override Response HandleUnauthorizedRequest(Request request, IUri uri)
        {
            return new Response(ResponseType.Unauthorized, null, uri, request, null, null);
        }
    }
}
