...
public class DictionaryChangingEventArgs<TKey, TValue> : CollectionChangingEventArgs<KeyValuePair<TKey, TValue>>
{
    ...
    public static DictionaryChangingEventArgs<TKey, TValue> Add(IDictionaryView<TKey, TValue> source, IDictionaryView<TKey, TValue> addedItems) => new(source, addedItems, null, DictionaryChangeType.Add);

    public static DictionaryChangingEventArgs<TKey, TValue> Remove(IDictionaryView<TKey, TValue> source, IDictionaryView<TKey, TValue> removedItems) => new(source, null, removedItems, DictionaryChangeType.Remove);
    ...
    public static DictionaryChangingEventArgs<TKey, TValue> Clear(IDictionaryView<TKey, TValue> source, IDictionaryView<TKey, TValue> clearedItems) => new(source, null, clearedItems, DictionaryChangeType.Clear);
}