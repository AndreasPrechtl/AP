...
namespace AP.Data
{
        ...
        where TEntityContext : EntityContextBase
    {
        ...
        public Collections.IListView<TEntity> Update<TEntity>(Expression<Predicate<TEntity>> where, Action<TEntity> action) where TEntity : class
        {
        ...
        public Collections.IListView<TEntity> Delete<TEntity>(Expression<Predicate<TEntity>> where) where TEntity : class
        {
