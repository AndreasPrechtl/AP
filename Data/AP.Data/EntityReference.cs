    ...
    where TEntity : class
{
    ...
    protected Func<TKey, TEntity> ValueResolver => _valueResolver;

    protected Func<TEntity, TKey> KeySelector => _keySelector;
    ...
    public virtual bool Equals(TKey other) => this.Key.Equals(other);

    #endregion

    #region IComparable<TKey> Members

    public virtual int CompareTo(TKey key) => Comparer<TKey>.Default.Compare(this.Key, key);
