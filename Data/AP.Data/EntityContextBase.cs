...
namespace AP.Data
{
    ...
    public abstract class EntityContextBase : FinalizableObject, IEntityContext
    {
        ...
        private readonly AP.Collections.Dictionary<Type, object> _entitySets = new AP.Collections.Dictionary<Type, object>();
        ...
        public IEntitySet<TEntity> GetEntitySet<TEntity>() where TEntity : class
        {
            ...
            lock (_syncRoot)
            {
                ...
                object es = null;
                if (_entitySets.Contains(type, out es))
        ...
        protected virtual TEntity OnGetNewEntity<TEntity>()
        {
            return AP.New.Instance<TEntity>();
        }
