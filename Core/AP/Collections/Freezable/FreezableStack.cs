...
public class FreezableStack<T> : ExtendableStack<T>, IFreezable
{
    ...
    public new FreezableStack<T> Clone() => (FreezableStack<T>)this.OnClone();

    protected override CollectionBase<T> OnClone() => new FreezableStack<T>(this, this.Comparer, this.IsFrozen);
