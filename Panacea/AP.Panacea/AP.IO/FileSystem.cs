...
namespace AP.IO
{
    ...
    public abstract class FileSystem : StaticType
    {
        ...
        /// </summary>
        public static FileSystemContext Context { get { return _context ?? new FileSystemContext(); } }
        ...
        public static FileSystemEntry Get(string fullName)
        {
        ...
        public static bool TryGet(string fullName, out FileSystemEntry target)
        {
            return Context.TryGet(fullName, out target);
        }
        ...
        {
            return Context.Exists(fullName);
        }
        ...
        /// <param name="target">The output.</param>
        /// <returns>Returns true when a FileSystemEntry can be retrieved.</returns>
        public static bool Exists(string fullName, out FileSystemEntry target)
        {
            return Context.Exists(fullName, out target);
        }
        ...
        public static Directory GetParent(string fullName)
        {
            return Context.GetParent(fullName);
        }
        ...
        public static void Copy(FileSystemEntry source, Directory target, bool overwrite = false, string newName = null)
        {
            Context.Copy(source, target, overwrite, newName);
        }
        ...
        /// <param name="overwrite">Indicates if any existing file or directory should be deleted first.</param>
        /// <param name="newName">An alternate new name.</param>
        public static void Move(FileSystemEntry source, Directory target, bool overwrite = false, string newName = null)
        {
            Context.Move(source, target, overwrite, newName);
        }
        ...
        public static void Delete(FileSystemEntry target, bool permanent = true)
        {
        ...
        public static File CreateFile(string fullName, FileCreationOptions options = FileCreationOptions.None, FileSecurity security = null, bool overwrite = false)
        {
            return Context.CreateFile(fullName, options, security, overwrite);
        }
        ...
        public static Directory CreateDirectory(string fullName, DirectorySecurity security = null, bool overwrite = false)
        {
            return Context.CreateDirectory(fullName, security, overwrite);
        }
    }
}
