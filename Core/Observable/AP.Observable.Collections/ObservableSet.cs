...
public class ObservableSet<T> : ExtendableSet<T>, INotifySetChanged<T>, INotifySetChanging<T>, INotifyCollectionChanged, INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    public new ObservableSet<T> Clone() => (ObservableSet<T>)OnClone();

    protected override CollectionBase<T> OnClone() => new ObservableSet<T>(this, this.Comparer);
    ...
    {
        Set<T> removedItems = new(this.Comparer);
    ...
    {
        Set<T> removedItems = new(this.Comparer);
        Set<T> addedItems = new(this.Comparer);
