...
namespace AP.Linq
{
    public static class QueryableExtensions
    {
        ...
        public static IOrderedQueryable<T> Sort<T, TKey>(this IQueryable<T> source, Expression<KeySelector<T, TKey>> keySelector, SortDirection sortDirection, IComparer<TKey> keyComparer = null)
        {
            return Sort(source, keySelector.Cast<Func<T, TKey>>(), sortDirection, keyComparer);
        }
        ...
        public static IOrderedQueryable<T> Sort<T, TKey>(this IQueryable<T> source, Expression<Func<T, TKey>> keySelector, SortDirection sortDirection, IComparer<TKey> keyComparer = null)
        {
            if (sortDirection == SortDirection.Unsorted)
                ExceptionHelper.AssertNotNull(() => sortDirection);
        ...
        public static SortDirection GetSortDirection<T>(this IQueryable<T> source)
        {
            if (source is IOrderedQueryable<T>)
            {
                MethodCallExpression e = source.Expression as MethodCallExpression;
                if (e == null)
