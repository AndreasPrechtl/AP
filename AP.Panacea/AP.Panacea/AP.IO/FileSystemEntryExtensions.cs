...
namespace AP.IO
{
    ...
    public static class FileSystemEntryExtensions
    {
        ...
        public static void MoveTo(this FileSystemEntry source, Directory target, bool overwrite = false, string newName = null)
        {
            FileSystem.Context.Move(source, target, overwrite, newName);
        }
        ...
        /// <param name="overwrite">Indicates if any existing file or directory should be deleted first.</param>
        /// <param name="newName">An alternate new name.</param>
        public static void CopyTo(this FileSystemEntry source, Directory target, bool overwrite = false, string newName = null)
        {
            FileSystem.Context.Move(source, target, overwrite, newName);
        }
        ...
        public static void Delete(this FileSystemEntry target, bool permanent = true)
        {
            FileSystem.Context.Delete(target, permanent);
        }
    }
}
