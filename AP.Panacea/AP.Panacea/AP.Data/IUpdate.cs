...
namespace AP.Data
{
    public interface IUpdate
    {
        ...
        AP.Collections.IList<TEntity> Update<TEntity>(Expression<Predicate<TEntity>> where, Action<TEntity> action) where TEntity : class;
    }
        ...
        where TEntity : class
    {
        ...
        AP.Collections.IList<TEntity> Update(Expression<Predicate<TEntity>> where, Action<TEntity> action);
    }
