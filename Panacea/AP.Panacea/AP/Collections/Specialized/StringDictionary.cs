...
namespace AP.Collections.Specialized
{
    public class StringDictionary : NameValueDictionary<string>
    {
        ...
        public new StringDictionary Clone()
        {
            return (StringDictionary)this.OnClone();
        }

        protected override Dictionary<string, string> OnClone()
        {
            return new StringDictionary(this, this.KeyComparer, this.ValueComparer);
        }
    }
}
