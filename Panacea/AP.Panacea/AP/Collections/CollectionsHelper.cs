...
namespace AP.Collections
{
    ...
    {        
        public static bool Contains<T>(ICollection<T> collection, object item)
        {
            return IsCompatible<T>(item) && collection.Contains((T)item);
        }
        ...
        {
            SCG.List<T> list = new SCG.List<T>(collection.Count);
            SCG.List<T> newList = new SCG.List<T>(collection.Count);
        ...
        public static void Replace<T>(System.Collections.Generic.IList<T> list, IEnumerable<T> items, IEnumerable<T> newItems)
        {
            ...
            SCG.List<int> indexes = new SCG.List<int>(list.Count);
            SCG.List<T> newItemsList = new SCG.List<T>(list.Count);
