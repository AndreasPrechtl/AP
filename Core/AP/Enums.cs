...
namespace AP
{
    ...
    public static class Enums
    {
            ...
            where TEnum : struct, IComparable, IConvertible, IFormattable
        {
            ...
            return Enum.TryParse<TEnum>(value, ignoreCase, out parsed);
        }
            ...
            where TEnum : struct, IComparable, IConvertible, IFormattable
        {
            ...
            AP.Collections.Specialized.NameValueDictionary<TEnum> dict = new AP.Collections.Specialized.NameValueDictionary<TEnum>(l);
        ...
        public static AP.Collections.Specialized.ReadOnlyNameValueDictionary<TEnum> ToReadOnlyDictionary<TEnum>()
            where TEnum : struct, IComparable, IConvertible, IFormattable
        {
            return new Collections.Specialized.ReadOnlyNameValueDictionary<TEnum>(Enums.ToDictionary<TEnum>());
        }
