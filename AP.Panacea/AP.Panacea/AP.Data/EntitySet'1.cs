...
namespace AP.Data
{
        ...
        where TEntity : class
    {
        ...
        public virtual Collections.IList<TEntity> Update(System.Linq.Expressions.Expression<Predicate<TEntity>> where, Action<TEntity> action)
        {
        ...
        public virtual Collections.IList<TEntity> Delete(System.Linq.Expressions.Expression<Predicate<TEntity>> where)
        {
