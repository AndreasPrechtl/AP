...
namespace AP.Collections
{
    ...
    public class FreezableDictionary<TKey, TValue> : ExtendableDictionary<TKey, TValue>, IFreezable
    {
        ...
        public new FreezableDictionary<TKey, TValue> Clone()
        {
            return (FreezableDictionary<TKey, TValue>)this.OnClone();
        }

        protected override CollectionBase<KeyValuePair<TKey, TValue>> OnClone()
        {
            return new FreezableDictionary<TKey, TValue>(this, this.KeyComparer, this.ValueComparer, this.IsFrozen);
        }
