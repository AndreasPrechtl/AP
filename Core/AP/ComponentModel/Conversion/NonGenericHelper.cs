...
public sealed class NonGenericHelper
{
    ...
    public object Convert(object input, Type outputType, CultureInfo? inputCulture = null, CultureInfo? outputCulture = null) => _manager.GetConverter(input.GetType(), outputType).Convert(input, inputCulture, outputCulture);
