...
namespace AP.Data
{
    public interface IDelete
    {
        ...
        AP.Collections.IList<TEntity> Delete<TEntity>(Expression<Predicate<TEntity>> where) where TEntity : class;
    }
        ...
        where TEntity : class
    {
        ...
        AP.Collections.IList<TEntity> Delete(Expression<Predicate<TEntity>> where);
    }
