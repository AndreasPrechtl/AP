...
namespace AP.UI
{
    public static class QueryableExtensions
    {
        ...
        {
            return new QueryableViewModel<T, TKey>(source, keySelector, currentKey, sortDirection, keyComparer);
        }
        ...
        {
            return new QueryableViewModel<T, TNavigation, TKey>(source, linkCreator, keySelector, currentKey, sortDirection, keyComparer);
        }
        ...
        {
            return new QueryablePagedViewModel<T, TKey>(source, keySelector, currentPage, pageSize, sortDirection, keyComparer);
        }
        ...
        {
            return new QueryablePagedViewModel<T, TNavigation, TKey>(source, linkCreator, keySelector, currentPage, pageSize, sortDirection, keyComparer);
        }
    }
}
