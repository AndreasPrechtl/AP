...
{
    private AP.Collections.Dictionary<object, DataOperation> _pendingChanges = new();
    private Set<object> _data = new();
    ...
    protected override IEntityModel CreateEntityModel() => new EntityModel<InMemoryEntityContext>(this);

    protected override IEntitySet<TEntity> CreateEntitySet<TEntity>() => new EntitySet<InMemoryEntityContext, TEntity>(this);
